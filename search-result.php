...
<div class= "page-banner" style="background-color: black; color:gold;">
<div class="inner">
    <h3 style="color: gold; padding-left: 50px;"> Showing results for: <?php $search_text = strip_tags($_REQUEST['search_text']);
    echo $search_text;
    ?>
    </h3>
</div>
                                ...
                                <div class="col-md-3 item item-search-result">
                                    <div class="inner">
                                        ...
                                        <div class="text">
                                            ...
                                            <?php else: ?>
                                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>">View Details</a></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>

...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
    ...
    <a class="left carousel-control" href="#bootstrap-touch-slider" role="button" data-slide="prev" style="color: gold;">
        <span class="fa fa-angle-left" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="#bootstrap-touch-slider" role="button" data-slide="next" style="color: gold;">
...
<div class="product pt_70 pb_70" style="background-color: black;color: gold;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
            ...
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/<?php echo $row['p_featured_photo']; ?>); image-rendering: high-quality;"></div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                                <h3><a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_name']; ?></a></h3>
                                <h4>
                                    N<?php echo $row['p_current_price']; ?> 
                                </h4>
                                <?php if($row['p_qty'] == 0): ?>
                                ...
                                <?php else: ?>
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-eye"></i> View Details</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
...
<div id="featured" class="product pt_70 pb_30" style="background-color: black;color: gold;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
